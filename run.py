...
twitch_miner = TwitchChannelPointsMiner(
    username="bomb_bartu",
    password="bomb_bartu_010203040506070809",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        telegram=Telegram(                                                          # You can omit or set to None if you don't want to receive updates on Telegram
            chat_id=1633791365,                                                      # Chat ID to send messages @getmyid_bot
            token="5777484694:AAErp5x7gvDdjKezX2R0fJW0ZuOs2nbN-IQ",                          # Telegram API token @BotFather
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.BET_LOSE, Events.BET_WIN, Events.CHAT_MENTION, Events.GAIN_FOR_CLAIM, Events.GAIN_FOR_WATCH, Events.GAIN_FOR_RAID, Events.GAIN_FOR_WATCH_STREAK],   # Only these events will be sent to the chat
            disable_notification=True,                                              # Revoke the notification (sound/vibration)
        ),
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1104720424450920508/8Ctc5c7ODOJ0v_C2zrHtvrGjwvb2xdZp4oLWsUWPP1c_UCpnD4Vu9SLydUINYMJYGmkk", # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.BET_LOSE, Events.BET_WIN, Events.CHAT_MENTION, Events.GAIN_FOR_CLAIM, Events.GAIN_FOR_WATCH, Events.GAIN_FOR_RAID, Events.GAIN_FOR_WATCH_STREAK],   # Only these events will be sent to the chat
        )
    ),
